...
TICKET="$(git -C "$MAIN_ROOT" ls-files ".scratch/picode-1-6/issues/${NN}-*.md" ".scratch/picode-1-5/issues/${NN}-*.md" ".scratch/picode-1-4/issues/${NN}-*.md" ".scratch/picode-1-3/issues/${NN}-*.md" ".scratch/picode-1-1/issues/${NN}-*.md" ".scratch/picode-1-0/issues/${NN}-*.md" | head -1)"
if [[ -n "$TICKET" ]]; then
