...
三十四项需求（R1–R25）加九条 Round 10–16 增补（R26–R34），全部对齐实证参照（ZCode 实拍帧/bundle 键表 / Pi 包文档 / 会话记录形态）：
